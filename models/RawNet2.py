...
class RawNet2(nn.Module):
    def __init__(self, nb_samps: int = 59440):
        super(RawNet2, self).__init__()

        self.ln = LayerNorm(nb_samps)
        ...
        self.block3 = nn.Sequential(Residual_block_wFRM(nb_filts = [256,256]))
...
def MainModel(nb_samps,**kwargs):
    model = RawNet2(nb_samps=nb_samps)
    return model